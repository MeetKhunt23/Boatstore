...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2023 at 09:08 AM
...
CREATE TABLE `admin` (
  ...
  `free_homedelivery_on_amount` float(12,2) NOT NULL,
  `shipping_charge` float(12,2) NOT NULL,
  `create_date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `admin` (`id`, `user_name`, `password`, `first_name`, `last_name`, `email`, `free_homedelivery_on_amount`, `shipping_charge`, `create_date`) VALUES
(1, 'admin', 'Meet@98255', 'Meet', 'Patel', 'admin@admin.com', 2000.00, 50.00, '2023-06-13 05:07:10');
...
CREATE TABLE `cart` (
  ...
  `selling_price` float(12,2) NOT NULL,
...
INSERT INTO `cart` (`id`, `user_id`, `product_id`, `price`, `selling_price`, `quantity`, `total_price`, `create_date`) VALUES
(85, 16, 2, 600.00, 550.00, 1, 550.00, '2023-06-14 11:08:42');
...
INSERT INTO `categories` (`id`, `category_name`, `category_image`, `create_date`) VALUES
(1, 'Smart watch', '71IbtYa4G1S._AC_UY1000_.jpg', '2023-06-02 03:52:10'),
(2, 'Ear Phones', 'i7-tws-earbuds-500x500.jpg', '2023-06-02 05:05:06'),
(3, 'R-neck earphones', '626364818_max.jpg', '2023-06-02 05:27:10'),
(4, 'Speakers', '6359c0311f2ec6580717f167-bluetooth-speakers-coumson-portable.jpg', '2023-06-02 05:29:10');
...
CREATE TABLE `products` (
  ...
  `avg_rating` int(12) NOT NULL,
  `total_review` int(12) NOT NULL,
  `expected_delivery_time` varchar(255) NOT NULL,
  `create_date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `products` (`id`, `product_key`, `category_id`, `name`, `image`, `price`, `selling_price`, `description`, `avg_rating`, `total_review`, `expected_delivery_time`, `create_date`) VALUES
(1, '', 1, '0_Switzerland-BINGER-Men-Watch', '0_Switzerland-BINGER-Men-Watches-Luxury-Brand-Sapphire-Japan-Automatic-Mechanical-Watch-Men-Luminous-Hands-Stainless-Steel_large.webp', 599.00, 500.00, 'Great collections of switzerland available till the date', 7, 3, '10 days', '2023-06-05 06:16:03'),
(2, '', 1, 'men101-brown-black-rishtey-boys', 'men101-brown-black-rishtey-boys-original-imagf3b9azfxmdna.webp', 600.00, 550.00, 'Men\'s special casual watch', 4, 1, '5 days', '2023-06-05 06:18:12'),
(3, '', 1, 'New-Silicone-Digital-Watch-Men-Sport', 'New-Silicone-Digital-Watch-Men-Sport-Women-Watches-Electronic-LED-Ladies-Male-Wrist-Watch-For-Men.jpg', 1000.00, 900.00, 'Digital watch with full android facility', 10, 5, '5 days', '2023-06-05 06:20:06'),
(4, '', 1, 'Ocla-100 Tissot', 'n10.jpeg', 800.00, 700.00, 'This is premium collection watch', 4, 1, '5 days', '2023-06-05 06:22:15'),
(5, '', 2, 'Classic e-podes with long battery backup', 's-l1600.jpg', 1100.00, 1000.00, 'This is best seller among all products', 11, 10, '5 days', '2023-06-05 06:56:09'),
(6, '', 2, 'E6s TWS series', 'd552cb3272409c0d44838ead737f02a24e2113b6_original.jpeg', 900.00, 850.00, 'This has 24 hours of battery back up', 9, 8, '5 days', '2023-06-05 06:58:05'),
(7, '', 2, 'Magical Flash Boats', '5196kkK3W6L._AC_UF1000,1000_QL80_.jpg', 1500.00, 1350.00, 'This has exclusive collection of wide range colors with flash ibuilt', 10, 15, '5 days', '2023-06-05 06:59:51'),
(8, '', 2, 'Amazon special colored birds', '41oAjl9WRTL._AC_UF350,350_QL80_.jpg', 800.00, 700.00, 'premium quality sound with best user experience', 8, 15, '6 days', '2023-06-05 07:01:37'),
(9, '', 3, 'Amazon special r-neck', '-original-imagewuzhfbtygzw.webp', 2200.00, 2000.00, 'Primium quality with long battery backup', 9, 20, '5 days', '2023-06-05 07:18:38'),
(10, '', 3, 'Headphone-Zone-Focal-Bauthys-New-01', 'Headphone-Zone-Focal-Bauthys-New-01.webp', 1600.00, 1500.00, 'Headphone-Zone-Focal-Bauthys-New-01 with best sound experience', 9, 15, '5 days', '2023-06-05 07:21:39'),
(11, '', 3, 'Cg-earphones with big bang', 'CVGPIoivkr.webp', 2500.00, 2400.00, 'Cg-earphones with big bang long duration quality', 9, 25, '4 days', '2023-06-05 07:23:18'),
(12, '', 3, 'Bluetooth-Headphone-Over-Ear-Sunrise-B6', 'Bluetooth-Headphone-Over-Ear-Sunrise-B6-Premium-Stereo-Sound-Wireless-Headsets-Big-Size-Earmuffs-Support-Siri-and-Google-Assistant-Foldable-Headset-with-Mic.webp', 1900.00, 1800.00, 'Bluetooth-Headphone-Over-Ear-Sunrise-B6-Premium-Stereo-Sound-Wireless-Headsets-Big-Size-Earmuffs-Support-Siri-and-Google-Assistant-Foldable-Headset-with-Mic', 9, 51, '6 days', '2023-06-05 07:24:21'),
(13, '', 4, 'PS30 Wireless Bluetooth Party Speaker', 'PS30.webp', 5000.00, 2800.00, 'Outdoor Party Speaker Karaoke Ready Phone Holder All Bluetooth Audio devices supporting', 8, 25, '5 days', '2023-06-05 07:26:46'),
(14, '', 4, 'Portable Bluetooth Speakers LED Lights', '71NznE3KmKL.jpg', 2500.00, 1750.00, 'Portable Bluetooth Speakers LED Lights 6 Patterns Visual Wireless Speaker 4.1 HD Bass Powerful Sound', 9, 55, '5 days', '2023-06-05 07:28:37'),
(15, '', 4, 'Z-Drum Wireless Speakers', 'Z-Drum-pic1_600x600_crop_center.jpg', 2500.00, 2200.00, 'Z-Drum-Wireless Speakers with sterio support', 8, 15, '4 days', '2023-06-05 07:30:40'),
(16, '', 4, 'Wireless Portable Speakers With BT, USB, AUX, FM - Zebronics', 'Zeb-Thump-800-pic1_5ede24f3-a989-49f1-a750-85d3f60249a7_540x.webp', 3500.00, 2900.00, ' Speakers With BT,  USB, AUX, FM -endless user experience with all supprote version', 10, 65, '5 days', '2023-06-05 07:34:11');
...
INSERT INTO `product_review` (`id`, `user_id`, `product_id`, `rating`, `review`, `create_date`) VALUES
(1, 16, 4, 4.00, 'nice watch', '2023-06-15 03:48:12'),
(2, 16, 2, 4.00, 'stylish watch', '2023-06-15 05:42:56');
...
(2, 'MEET', 'KHUNT', '856565525565', 'meetkhunt23011@gmail.com', 'meet@1304989', 1, 'kee movie.png', 0, 101, 12, 952, 0, 0, '2023-06-03 07:54:53'),
(3, 'Meet', 'Khunt', '9586555250', 'meetkhunt2301@gmail.comm', '', 1, '25.jpg', 0, 101, 12, 952, 0, 0, '2023-06-03 09:01:44'),
(4, 'Meet', 'Khunt', '9106656842', 'meetkhunt@gmail.com', '', 1, 'download (3).jfif', 0, 101, 12, 957, 0, 0, '2023-06-03 11:09:26'),
(5, 'vsdfvv', 'dfvdfv', '45115050', 'adfvmdznmfrnv', '', 1, 'aadsd.png', 0, 101, 10, 0, 0, 0, '2023-06-03 11:10:13'),
(6, 'ekrjfkdnfd', 'ermflsmf', '654532123', 'emr,fneamrnf', '', 1, '1d7b498d-e5bc-461f-94f8-695d4171a9a6.jfif', 0, 101, 13, 14, 0, 0, '2023-06-03 11:12:50'),
(7, 'nrfnrf', 'amrnfkarf', '84652', 'wrbfsbdc', '', 1, '25.jpg', 0, 101, 13, 14, 0, 0, '2023-06-03 11:34:16'),
(8, 'rvef', 'srcsrc', '645315321', 'rfasrfc', '', 1, '12-5-hp-commercial-submersible-pump-250x250.jpg', 0, 101, 12, 961, 0, 0, '2023-06-03 12:15:54'),
(9, 'efafc', 'erfreac', '945103651', 'adhcnja d', '', 1, 'images (4).jfif', 0, 101, 12, 961, 0, 0, '2023-06-03 12:17:37'),
(10, 'jhfghhb', 'hjghbm', '6562', 'hftrfhgh', '', 1, '25.jpg', 0, 101, 12, 961, 0, 0, '2023-06-03 12:23:24'),
(11, 'svzgvf', 'sdgfvsgvf', '454572', 'ddbvcbg', '', 1, '12-5-hp-commercial-submersible-pump-250x250.jpg', 0, 101, 8, 992, 0, 0, '2023-06-03 13:28:33'),
(12, 'meet ', 'khunt', '98948455', 'gfvdfvc@mgdfgv', '', 1, 'images (7).jfif', 0, 101, 9, 42, 0, 0, '2023-06-05 04:02:18'),
(13, 'meet', 'khunt', '625515015121', 'nbfjsj@fjsk.cpom', '', 1, '12-5-hp-commercial-submersible-pump-250x250.jpg', 0, 101, 5, 1, 0, 0, '2023-06-05 04:05:01'),
(14, 'parth', 'gohil', '845628647', 'parthgohil@gmail.com', '123456789', 1, 'IMG_20210720_205011 (1).JPG', 0, 101, 12, 952, 0, 0, '2023-06-06 11:32:31'),
(15, 'meet', 'khunt', '62551501512', 'nbfjsj@fjsk.cpo', '1221220102', 1, '12-5-hp-commercial-submersible-pump-250x250.jpg', 0, 101, 5, 1, 0, 0, '2023-06-06 11:42:02'),
(16, 'parth', 'gohil', '554154515215', 'meerigi!jkm.com', '9106689874', 1, 'IMG_20210720_205011 (1).JPG', 0, 101, 12, 952, 0, 0, '2023-06-06 11:45:38'),
(17, 'meet', 'khunt', '645984515', 'arhfs gfjnjfv', 'kgjfkdlmṅ', 1, 'images (8).jpg', 0, 101, 12, 952, 0, 0, '2023-06-07 12:45:06'),
(18, 'nfjknfkc', 'klarmfasmrf', '553232', 'lkrmfrlf,ls', 'askrfmlksmrf', 1, 'kee1.png', 0, 101, 12, 966, 0, 0, '2023-06-07 13:01:42'),
(19, 'jkdnfkjsnd', 'msdfmsd', '6456523021', 'meet@knf.com', 'meet@91066', 1, '113.jpg', 0, 101, 17, 3476, 0, 0, '2023-06-09 06:04:57'),
(20, 'dmnfm,sdm,', 'sd,mfsmc ', '6565656562', 'dncnm@jnj.com', 'meet@6846', 0, '112.jpg', 0, 101, 12, 960, 0, 0, '2023-06-09 06:05:59'),
(21, 'sfsd ', 's,mdf s,c', '9858787459', 'jn@nn.com', 'mee@4455', 1, '111.jpg', 0, 101, 12, 963, 0, 0, '2023-06-09 06:10:45'),
(22, 'sfv ', 'sf.v,vsfksmv', '998975558755', 'meeet@mdm.com', 'nmed@651', 1, '111.jpg', 0, 101, 7, 1887, 0, 0, '2023-06-09 06:13:24'),
(23, 'sfnsmdnm', 'sm,fmsmf', '625515015116', 'mee@4744.com', 'met@8455', 1, '112.jpg', 0, 101, 12, 961, 0, 0, '2023-06-09 06:39:59'),
(24, 'dfvf', 'fvdf', '85416515323', 'eeh@jdf.com', 'kdnsj@4545', 1, '112.jpg', 0, 101, 10, 7279, 0, 0, '2023-06-09 06:46:24'),
(25, 'sfnskd', 'jsnfms', '65452343854', 'mmeet!@Jdfs.com', 'MEMEM25454@', 1, '113.jpg', 0, 101, 12, 953, 0, 0, '2023-06-09 06:49:46'),
(26, 'sndbfn', 'aednka', '656086506', 'e44545@c.com', 'meet@54515', 1, '115.jpg', 0, 101, 12, 960, 0, 0, '2023-06-09 06:52:57'),
(27, 'smefnjks', 'sef sm, ', '5415415435102', 'kankmd@mlnsdkfm.com', 'andn@454', 1, '112.jpg', 0, 101, 11, 1865, 0, 0, '2023-06-09 06:54:58'),
(28, 'skefnsj', 'sdfms,c sm', '6556898264056', 'akjd6545h@ccp.cpok', 'akedjnk@44', 1, '112.jpg', 0, 101, 12, 959, 0, 0, '2023-06-09 07:00:46'),
(29, 'sdncjkn', 'zm,dnmz', '6523515132123', 'skldkcn@jnmk.cpok', 'mnd@54154', 1, '112.jpg', 0, 101, 13, 18, 0, 0, '2023-06-09 07:03:06'),
(30, 'wmnebjksns', 'sm,fkn', '623526850260262', 'meet@625562.com', 'kjrfkjhj@nj65', 1, '115.jpg', 0, 101, 12, 962, 0, 0, '2023-06-09 07:16:33'),
(31, 'sckjsncsdcbxjcnx skjdnc', 'mnsd cs', '65535616323', 'meet@jnsjnm.com', 'md@ckmkl', 1, '112.jpg', 0, 101, 12, 960, 0, 0, '2023-06-09 07:18:55'),
(32, 'ksdfmks', 'jsndkdks', '5654532564541', 'amnmdbn@JN.cpk', 'ejdnj!5454', 0, '111.jpg', 0, 101, 12, 966, 0, 0, '2023-06-09 07:21:51'),
(33, 'ajkdnakn', 'asdamn', '42455605153', 'ememj@kjnkm54.com', 'jdnkjn!424', 1, '112.jpg', 0, 101, 12, 962, 0, 0, '2023-06-09 07:24:07'),
(34, 'sm dm sm', 'skdm,sms', '65456431212', 'meehg!@57.cpm', 'kledka55@', 1, '111.jpg', 0, 101, 15, 180, 0, 0, '2023-06-09 07:25:41'),
(35, 'sfnkms', 'm,f,ms ', '64566562515', 'smdm@ksndcm454.com', 'sndnnnk@54', 1, '115.jpg', 0, 101, 12, 960, 0, 0, '2023-06-09 07:57:11'),
(36, 'sdfm,s m', 'mdmna', '8456462552', 'mmfn@jnkmk.com', 'jnf@4155', 1, '111.jpg', 0, 101, 12, 957, 0, 0, '2023-06-09 07:59:23'),
(37, 'wnfsmf', 'wmfm,fm,', '6545646532', ',dm@m,fm,.com', 'jsm@mm.com', 1, '115.jpg', 0, 101, 12, 958, 0, 0, '2023-06-09 09:06:31'),
(38, 'kjafnasmndfm', 'kjsafnsaknd', '65656325645', 'menm@gmail.coim', 'klemdwmk!m54', 1, '12-5-hp-commercial-submersible-pump-250x250.jpg', 0, 101, 14, 175, 0, 0, '2023-06-09 09:14:43'),
(39, 'knfmsnf', 'sfsmfnsd ', '75452421', 'meetklfk@jnn.com', 'mksmd@454', 1, '25.jpg', 0, 101, 12, 962, 0, 0, '2023-06-09 09:16:16'),
(40, 'jksfns,mc', 'nsdf mzc', '745534212', 'smdfnm,s@kmkm.co,', 'meey@444', 1, 'images (1).png', 0, 101, 12, 955, 0, 0, '2023-06-09 09:18:02'),
(41, 'slfms,f', 'sm,f asfm', '5453213252', ',em@jnk,cpk', 'wemdnjkn454@', 1, '25.jpg', 0, 101, 12, 966, 0, 0, '2023-06-09 09:19:51'),
(42, 'meet', 'khunt', '655864512553', 'meet@58755.comm', 'mee@5454', 1, '25.jpg', 0, 101, 12, 962, 0, 0, '2023-06-10 05:42:32'),
(43, 'meet', 'khunt', '85332354532', 'meniuhn@5454.com', 'lkfmkmfk!65', 1, 'images.jfif', 0, 101, 12, 958, 0, 0, '2023-06-10 05:43:44'),
(44, 'meet', 'kghur', '56456123123', 'wjenfk@c.com', 'kljskl@687564', 1, 'epcote-et140-epoxy-coating-250x250.jpg', 0, 101, 12, 956, 0, 0, '2023-06-10 05:45:14'),
(45, 'meet', 'khunt', '6255150121', 'nbfjsj@fjsk.cpos', '1221220102', 1, 'VID-20190908-WA0013.mp4', 0, 101, 5, 1, 0, 0, '2023-06-12 06:16:15');
...
--
ALTER TABLE `product_review`
  ADD CONSTRAINT `product_review_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
